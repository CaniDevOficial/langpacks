...
$lang = array_merge($lang, [
	...
	'REACTIONS_ANONYMOUS'				=> 'Ανώνυμες αντιδράσεις',
	'REACTIONS_ANONYMOUS_EXPLAIN'		=> 'Ενεργοποιήστε αυτήν την επιλογή εάν θέλετε τα ονόματα χρηστών να μην εμφανίζονται στις λίστες αντιδράσεων.<br />
		<em>Αυτή η επιλογή δεν επηρεάζει τους χρήστες που έχουν άδεια να μετριάζουν τις αντιδράσεις.</em>',
	...
	'REACTIONS_FORUMS'					=> 'Φόρουμ όπου οι χρήστες μπορούν να αντιδράσουν',
	'REACTIONS_FORUMS_EXPLAIN'			=> 'Καθορίζει τα φόρουμ στα οποία θα εμφανίζονται οι αντιδράσεις.<br />
		Εάν δεν επιλέξετε κανένα, οι αντιδράσεις θα εμφανίζονται σε όλα τα φόρουμ.<br />
		Μπορείτε να επιλέξετε όσες θέλετε χρησιμοποιώντας το πλήκτρο <em>Ctrl</em> στο πληκτρολόγιό σας.',
